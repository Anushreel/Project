...
# Use existing PDF if none uploaded
default_pdf_path = "data/paper.pdf"  # Replace with the path to your default PDF
if not os.path.exists(default_pdf_path):
    st.error("Default PDF file not found. Please upload a PDF.")
    st.stop()
...
elif uploaded_file is None and prompt_input and model_choices:
    st.info("No PDF uploaded. Using the default PDF.")
    pdf_path = default_pdf_path

if pdf_path and prompt_input and model_choices:
